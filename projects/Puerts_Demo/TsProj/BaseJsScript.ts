...
export class BaseJsScript
{
    ...
    /*Start() : void {
        UnityEngine.Debug.Log( "BaseJsScript.JsStart()" );
    }
    FixedUpdate() : void {    
        UnityEngine.Debug.Log( "BaseJsScript.JsFixedUpdate()" );  
    }
    JsUpdate() : void {    
        UnityEngine.Debug.Log( "BaseJsScript.JsUpdate()" );  
    }
    LateUpdate() : void {    
        UnityEngine.Debug.Log( "BaseJsScript.JsLateUpdate()" );  
    }
    Init( args?: any ) : void {
        UnityEngine.Debug.Log( "BaseJsScript.Init()" );  
    }
    Free( args?: any ) : void {
        UnityEngine.Debug.Log( "BaseJsScript.Free()" );  
    }*/
}
